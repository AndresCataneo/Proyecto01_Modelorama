...
public class DepartamentoElectrodomesticos extends Departamento{
     ...
     */
    public DepartamentoElectrodomesticos(String nombre) {
        super(nombre);
    }
    ...
    public void agregarProducto(){
        Producto producto1 = new Producto("Lavadora", 10000);
        Producto producto2 = new Producto("Refrigerador", 5000);
        Producto producto3 = new Producto("Estufa", 3000);
        Producto producto4 = new Producto("Licuadora", 2000);
        Producto producto5 = new Producto("Horno", 1000);
        Producto producto6 = new Producto("Microondas", 500);
