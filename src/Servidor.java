...
public class Servidor {
    ...
    */
    public Servidor(){
        ...
        listaClientes.add(new Cliente("RymerVS", "321", "Ryan", "5519032327", "N1 40", "XRX", "EUA", 2));
        listaClientes.add(new Cliente("JosephEvil", "123", "Jose", "5519032328", "N1 50", "JOS", "España", 3));
    }
